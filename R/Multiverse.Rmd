...
```{r}
fig_caterpillar <- plotCaterpillar(
  specs, n_total_specs, colors, k_range,
...
fig_cluster_tiles <- plotClusterTiles(
  specs, cluster_fill_data, n_total_specs,
  title, x_range
)
fig_cluster_tiles
```
...
fig_spec_tiles <- plotSpecTiles(
  specs, n_total_specs, spec_fill_data,
